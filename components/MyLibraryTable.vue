...
// Resuelve los componentes de Nuxt UI
...
// Define las props que el componente recibirá de la página padre
...
// Define las columnas de la tabla dentro del componente
...
// Exporta las columnas para que la página padre pueda usarlas
const table = ref()
const selectedRows = computed(() => table.value?.tableApi?.getFilteredSelectedRowModel().rows.length || 0)
